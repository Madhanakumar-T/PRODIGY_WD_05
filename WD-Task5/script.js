...
function changeBg(status) {
    if (status === 'Clouds') {
        ...
        document.body.style.backgroundImage = 'url(src/thunderstrom.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(src/drizzle.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(src/mist.jpg)';
    }

    else {
        document.body.style.backgroundImage = 'url(src/bg.jpg)';
    }
}
